...
export default function LoginPage() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // Handle the response based on the login operation status
      if (data.loginOperationStatus === 'success') {
        setSuccessMessage(data.message || 'Login successful!');
        // Here you would typically store any auth tokens and redirect the user
